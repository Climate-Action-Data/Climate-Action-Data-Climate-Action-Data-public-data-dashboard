    ...
    if (!carbonReduction?.data) {
        ...
        return <Box minW={"400px"}>
            <Stack>
                ...
                <Divider marginY={"20px"} />
                <Text as="h1" fontSize="lg" fontWeight="600" textAlign={"center"}>{t("carbonReduction.sector")}</Text>
                <CarbonReductionSector colorChart={colorChart} data={carbonReduction.data.sectors} />
                <Divider marginY={"20px"} />
                <Text as="h1" fontSize="lg" fontWeight="600" textAlign={"center"}>{t("carbonReduction.standard")}</Text>
